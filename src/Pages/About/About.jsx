...
const About = () => {
  ...
  return (
    <div className="bg-gray-100 pb-12">
      ...
      <Heading
        title="About Us"
        description="Innovative software solutions to power your business."
      />
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-24 py-12">
        <h2
          ...
          className="text-3xl font-bold text-center  text-[#39357D]"
        >
          Who We Are
        </h2>
        <div
          data-aos="fade-up"
          data-aos-duration="1500"
          className="mt-6 flex flex-col md:flex-row items-center justify-between"
        >
          <div className="md:w-1/2 p-4">
            <p className="text-lg text-justify">
              At HexaByte TM Solution, we are dedicated to delivering
              cutting-edge software solutions tailored to meet the unique needs
              of our clients. Our team of skilled professionals specializes in
              web development, mobile app development, and enterprise solutions,
              ensuring that your business operates efficiently and effectively.
              With a strong focus on innovation and quality, we strive to
              empower businesses to achieve their goals in the digital
              landscape.
            </p>
          </div>
