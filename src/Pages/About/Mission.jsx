    ...
    return (
        <section className="container mx-auto px-6 md:px-12 lg:px-24 py-12 bg-[#f4f4f4]">
            <div className="container mx-auto text-center">
                <h2 className="text-3xl font-bold mb-6 text-[#123955]">Our Mission and Vision</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Mission Section */}
                    <div className="border-2 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-r from-[#658baf] to-[#123955]">
